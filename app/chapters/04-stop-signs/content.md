...
**Pair each sign with a painted crosswalk.** A standard crosswalk costs roughly **$500–$1,500** to paint — white thermoplastic bars that tell every driver and every pedestrian exactly where the crossing is. Right now there are zero marked crosswalks on this stretch. Adding high-visibility ladder-style crosswalks at each stop sign turns an uncontrolled road into a legible one: drivers see the markings, stop at the sign, and yield to people in the crosswalk. Studies show marked crosswalks at stop-controlled intersections reduce pedestrian conflicts by up to **40%**.
