...
subtitle: 'RRFB • 20th Ave S & S Weller St'
icon: AlertTriangle
color: '#16a34a'
mapState:
  longitude: -122.3063
...
[FHWA field studies](https://safety.fhwa.dot.gov/provencountermeasures/rrfb.cfm) show RRFBs increase driver yielding from **18% to 81–88%** at previously uncontrolled crossings — and that improvement holds over time with no measurable decay.
